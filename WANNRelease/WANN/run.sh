...
python3 /home/marten.mueller/project/bioai/brain-tokyo-workshop/WANNRelease/WANN/wann_test.py -p 'p/cola_test.json' -o 'log/cola_test_result_' -i 'log/cola_best.out'
